...
import ArktikTravel from '../assets/video/arktik_travel.mp4';
import HandWatch from '../assets/video/handwatch.mp4';
import Kitchen from '../assets/video/kitchen.mp4';

export const VIDEOS = [
  { index: '1', content: F16Video, title: 'F-16', color: '#E8DCCC' },
  {
    index: '2',
    content: ArktikTravel,
    title: 'Arktik Travel',
    color: '#E1A9C4',
  },
  {
  ...
  { index: '4', content: Office, title: 'Foxes Print', color: '#E1A9C4' },
  { index: '5', content: Arpanet, title: 'ARPAnet net', color: '#FFFFFF' },
  { index: '6', content: BurgerVideo, title: 'Burger Club', color: '#E8DCCC' },
  { index: '7', content: SDesign, title: 'Sound Animation', color: '#e3bff2' },
  { index: '8', content: Kitchen, title: 'Kitchen', color: '#e3bff2' },
  { index: '9', content: MapVideo, title: 'Map USA', color: '#FFFFFF' },
  {
    index: '10',
    content: IndustryVideo,
    title: 'Industry Corporation',
    color: '#E1A9C4',
  },
  {
    index: '11',
  ...
  {
    index: '12',
    content: CoolinartVideo,
    title: 'Coolirant',
    color: '#ABABD1',
  },
  { index: '13', content: BusinessVideo, title: 'Business', color: '#E8B099' },
  {
    index: '14',
    content: StudioVideo,
    title: 'Recording studio Saxophon',
    color: '#FFFFFF',
  },
  {
    index: '15',
